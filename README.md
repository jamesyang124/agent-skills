...
*   **confluence-prd-to-sdd-spec**: Fetches an external PRD from Confluence (written by PO/PM) and transforms it into a structured local source file (`prd-source.md`) for the RD to reference when running `spec-kit specify`.
