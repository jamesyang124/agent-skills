...
See `.agent-settings/skills/workflows/sdd-tech-plan-to-confluence/references/workflow-integration.md` for the workflow position diagram and a full worked example.
